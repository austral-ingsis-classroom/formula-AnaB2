...
public class PrintTest {
  ...
  public void shouldPrintFunction3() {
    ...
    final String result = new Multiplication(new Parentheses(new Division(new Value(9),new Value(2))), new Value(3)).toString();
  ...
  public void shouldPrintFunction4() {
    ...
    final String result = new Power(new Parentheses(new Division(new Value(27),new Value(6))), new Value(2)).toString();
  ...
  public void shouldPrintFunction6() {
    ...
    final String result = new Subtraction(new Modulo(new Variable("value")), new Value(8)).toString();
  ...
  public void shouldPrintFunction8() {
    ...
    final String result = new Multiplication(new Parentheses(new Subtraction(new Value(5),new Variable("i") )), new Value(8)).toString();
    assertThat(result, equalTo(expected));
  }
}
